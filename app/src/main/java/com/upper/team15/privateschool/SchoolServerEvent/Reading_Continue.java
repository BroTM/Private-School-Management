...
public class Reading_Continue extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_reading__continue);
       ...
       // getSupportActionBar().setTitle(R.string.notice_title);
        ...
        data=Edata.get(pos);
        Glide.with(Reading_Continue.this).load(data.getEventImage()).diskCacheStrategy(DiskCacheStrategy.ALL)
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.continue_edit_event_image:
                Intent go=new Intent(Reading_Continue.this,Coming_Soon.class);
                startActivity(go);
                finish();
                break;
        }
